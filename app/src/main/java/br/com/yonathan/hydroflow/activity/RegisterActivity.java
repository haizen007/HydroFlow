...
public class RegisterActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inputName = findViewById(R.id.tv_name);
        inputCPF = findViewById(R.id.tv_cpf);
        inputPhone = findViewById(R.id.tv_phone);
        inputAddress = findViewById(R.id.tv_address);
        inputCEP = findViewById(R.id.tv_cep);
        inputEmail = findViewById(R.id.tv_email);
        inputPassword = findViewById(R.id.tv_password);
        ...
        final MaskedTextChangedListener maskCPF = new MaskedTextChangedListener(
                ...
                new MaskedTextChangedListener.ValueListener() {
                    @Override
                    public void onTextChanged(boolean b, @NotNull String s, @NotNull String s1) {
                    }
                }
        );
        ...
        StringRequest strReq = new StringRequest(Method.POST,
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        // User successfully stored into MySQL, retrieving its JSON data from PHP
