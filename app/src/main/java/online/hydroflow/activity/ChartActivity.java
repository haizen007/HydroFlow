...
public class ChartActivity extends FragmentActivity {
    ...
    private final AppVendor vendor = new AppVendor();
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        d1.setText("LineChart");                         // Description Text
        ...
        // add LineDataSet 1
        LineDataSet set1 = new LineDataSet(dataA, getString(R.string.chart_line_leg01));
        ...
        // add LineDataSet 2
        LineDataSet set2 = new LineDataSet(dataB, getString(R.string.chart_line_leg02));
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        d2.setText("BarChart");                 // Description Text
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        d3.setText("PieChart");                         // Description Text
        ...
        pieChart.setCenterText(getString(R.string.chart_pie_leg));     // Center Text
...
//        mTf = Typeface.createFromAsset(getAssets(), "OpenSans-Regular.ttf");
        ...
        d4.setText("Negative Positive Chart");   // Description Text
...
//        x4.setTypeface(mTf);                            // X Axis Text Font
...
//                Log.d(TAG, "##### " + e.toString() + " #####");
        ...
        NegativePositive.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                vendor.addToast(getString(R.string.long_press_save_img), ChartActivity.this);
                return true;
            }
        });
...
//            data.setValueTypeface(mTf);                   // Value Text Font
...
//            entries.add(new PieEntry(yData[i], xData[i]));
        ...
        dataSet.setSelectionShift(17f);                                     // Boundary Distance
